    ...
    <div className="posts">
      <div className="post-content" data-aos="zoom-in" data-aos-delay={200}>
        <div className="post-image">
          ...
          <div className="post-info flex-row">
            ...
            <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14, 2019</span>
            <span>2 Commets</span>
          </div>
        </div>
      ...
      <div className="post-content" data-aos="zoom-in" data-aos-delay={200}>
        <div className="post-image">
          ...
          <div className="post-info flex-row">
            <span><i className="fas fa-user text-gray" />&nbsp;&nbsp;Admin</span>
            <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 16, 2019</span>
            <span>7 Commets</span>
          </div>
        </div>
        <div className="post-title">
    ...
    <aside className="sidebar">
      ...
      <div className="popular-post">
        ...
        <div className="post-content" data-aos="flip-up" data-aos-delay={300}>
          <div className="post-image">
            <div>
              <img src={img11} className="imgg" alt="blog1" />
            </div>
            <div className="post-info flex-row">
              <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                2019</span>
        ...
        <div className="post-content" data-aos="flip-up" data-aos-delay={400}>
          <div className="post-image">
            <div>
              <img src={img12} className="imgg" alt="blog1" />
            </div>
            <div className="post-info flex-row">
              <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                2019</span>
        ...
        <div className="post-content" data-aos="flip-up" data-aos-delay={500}>
          <div className="post-image">
            <div>
              <img src={img6} className="imgg" alt="blog1" />
            </div>
            <div className="post-info flex-row">
              <span><i className="fas fa-calendar-alt text-gray" />&nbsp;&nbsp;January 14,
                2019</span>
