...
const Earthquakeinfo = () => {
    ...
    <div >
        <h1 class="title is-3">Earthquake Awareness / Preparedness</h1>
        <h4 class="title is-4">“Drop, Cover, Hold”</h4>
                ...
                <p>The “triangle of life” and some of the other actions recommended in the E-mail may not be the best
                    action to take. Additional information discussing the “triangle of life” is available at: 
                ...
                <p>Having an action plan that you have thought about in advance of an earthquake enhances the
                    probability you will make the best decision to prevent injuries. Follow these recommendations during
                    an earthquake:</p>
        ...
        <h4 class="title is-4">Indoors</h4>
        ...
        <h4 class="title is-4">Outdoors</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
        ...
        <h4 class="title is-4">Downtown:</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
        ...
        <h4 class="title is-4">Crowded Store</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
        ...
        <h4 class="title is-4">Driving</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
        ...
        <h4 class="title is-4">Wheelchair</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
        ...
        <h4 class="title is-4">Theater or stadium:</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
        ...
        <div class="content">
            <div class="rich-text">
                <p>Data from three University-based studies performed after the Loma Prieta (September, 1989) and
                ...
                <p>Methods like standing in a doorway, running outside, and some “triangle of life” techniques may
        ...
        <h4 class="title is-4">What Rescuers and Experts “DO NOT” Recommend You Do During An Earthquake</h4>
        <div class="content">
            <div class="rich-text">
                <ul>
                ...
                <p><b>For the best opportunity to reduce injury risk and improve your chances of survival in an
                ...
                <p><b>Additional preparedness information is available at:</b><a
                        href="http://www.ready.gov">www.Ready.gov</a></p>
