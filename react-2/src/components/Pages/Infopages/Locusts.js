    ...
    return (
     ...
     <ul className='paragraph'>
         ...
         agriculture due to their ability to form dense and highly mobile swarms. They are species of
          short-horned grasshoppers that periodically form large populations in dense migrating groups,
           where individuals differ in several characteristics from those living separately. </p>
           <li>In Australia there are three main pest species of locust</li><br/>
           ...
           <br/>
           <li>All three species are native to Australia. Locusts belong to the same order of insects as grasshoppers, katydids and crickets - the Orthoptera.</li>
           </ul>
...
<p>Locusts and grasshoppers are the same in appearance, but locusts can exist in two different 
    behavioural states (solitary and gregarious), whereas most grasshoppers do not. When the population
     density is low, locusts behave as individuals, much like grasshoppers. However, when locust population
      density is high, individuals undergo physiological and behavioural changes, known as phase polyphenism,
     and they form gregariously behaving bands of nymphs or swarms of adults.</p>
     <p>The distinction between locusts and grasshoppers is often not clear-cut, as the extent to which
          different species exhibit gregarious phase characters is graded. The migratory locust has all of the
           features associated with phase change - differences in body shape and colour, fertility and gregarious
            behaviour in both the nymph and adult life stages, forming dense bands and swarms.
             The Australian plague locust also forms dense nymph bands and adult swarms, but
              does not exhibit changes in body colour. Spur-throated locust nymphs do not form bands and
          the adults do not lay eggs gregariously, but they do form dense swarms.</p>
...
<ul className='paragraph'>
<p >Swarms of desert locusts are threatening large areas of pastures and crops, overwhelming countries in the
     Horn of Africa, the Middle East, and South Asia. The UN Food and Agriculture Organization (FAO) says
      these swarms represent the worst infestation in 25 years in Ethiopia and Somalia, in 26 years in India,
       and the worst in 70 years in Kenya. The crisis has affected 23 countries to date, from Pakistan to 
...
Within the region, 24 million people are food insecure and 8 million are internally displaced. 
 The locusts further threaten their food security and their ability to access pasture for livestock. 
  These impacts on the food cycle could drastically threaten livelihoods, erode people’s savings, and 
  push people further into poverty. The cost of response during the last major locust outbreak in 2003-05
   in West Africa, grew from $1 million in June 2003 to $100 million just 14 months later.
...
<li>A recent joint impact assessment report by the Government of Ethiopia and FAO estimates that 
    the desert locust outbreak in Ethiopia alone has caused 356,286 metric tons of cereal loss</li>
<li>along with destruction of 197,163 ha of cropland and 1,350,000 ha of pasturelands, with more than 1 million
     Ethiopians in need of food assistance as result.</li>
