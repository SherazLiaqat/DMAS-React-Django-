...
import population from "@amcharts/amcharts4-geodata/worldLow";
...
am4core.ready(function() {
  ...
  let covidseries = { active: activeSeries, confirmed: confirmedSeries, recovered: recoveredSeries, deaths: deathsSeries };
